...
import io.github.bandoracer.rommio.ui.navigation.TopLevelDestinations
import io.github.bandoracer.rommio.ui.screen.collection.CollectionDetailScreen
import io.github.bandoracer.rommio.ui.screen.collections.CollectionsScreen
import io.github.bandoracer.rommio.ui.screen.downloads.DownloadsScreen
import io.github.bandoracer.rommio.ui.screen.game.GameDetailScreen
import io.github.bandoracer.rommio.ui.screen.home.HomeScreen
import io.github.bandoracer.rommio.ui.screen.library.LibraryScreen
import io.github.bandoracer.rommio.ui.screen.platform.PlatformScreen
import io.github.bandoracer.rommio.ui.screen.settings.SettingsScreen
import io.github.bandoracer.rommio.ui.theme.BrandMuted
            ...
            if (showBottomBar) {
                NavigationBar(
                    ...
                    TopLevelDestinations.forEach { destinationItem ->
                        val selected = backStackEntry?.destination?.hierarchy?.any { it.route == destinationItem.route } == true
                        NavigationBarItem(
                            selected = selected,
                            onClick = {
                                navController.navigate(destinationItem.route) {
                            ...
                            icon = { Icon(destinationItem.icon, contentDescription = destinationItem.label) },
            ...
            NavHost(
                ...
                composable(NavRoutes.SETTINGS) {
                    SettingsScreen(
                        ...
                        onMigrationImported = {
                            scope.launch { onProfileActivated() }
                        },
                    )
                }
